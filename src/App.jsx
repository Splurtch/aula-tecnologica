...
export default function App() {
  ...
  const renderNavegadoresTab = () => null;
          ...
          <div className="space-y-10">
            <div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
                {generalistas.map(id => (
                  <InteractiveButton key={id} id={id} dataSet={aiData} extraClass="bg-slate-800 border-slate-700 text-slate-200" selectedItem={selectedItem} onSelect={handleSelect} colorMap={colorMap} isDark={isDark} />
                ))}
              </div>
            </div>
