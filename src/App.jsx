...
export default function App() {
  ...
  const renderDesktopTab = () => {
    ...
    const handleStartMenuDragStart = (e) => {
      ...
      setDragOffsetStartMenu({
        x: e.clientX - startMenuPos.x,
        y: e.clientY - startMenuPos.y
      });
    };
    ...
    const handleStartMenuDragMove = (e) => {
      ...
      setStartMenuPos({
        x: e.clientX - dragOffsetStartMenu.x,
        y: e.clientY - dragOffsetStartMenu.y
      });
    };
    ...
    const handleInformeDragStart = (e) => {
      ...
      setDragOffsetInforme({
        x: e.clientX - informePos.x,
        y: e.clientY - informePos.y
      });
    };
    ...
    const handleInformeDragMove = (e) => {
      ...
      setInformePos({
        x: e.clientX - dragOffsetInforme.x,
        y: e.clientY - dragOffsetInforme.y
      });
    };
    ...
    const handleFotoDragStart = (e) => {
      ...
      setDragOffsetFoto({
        x: e.clientX - fotoPos.x,
        y: e.clientY - fotoPos.y
      });
    };
    ...
    const handleFotoDragMove = (e) => {
      ...
      setFotoPos({
        x: e.clientX - dragOffsetFoto.x,
        y: e.clientY - dragOffsetFoto.y
      });
    };
